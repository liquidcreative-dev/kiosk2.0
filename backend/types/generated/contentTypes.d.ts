...
export interface ApiAthleteAthlete extends Schema.CollectionType {
  ...
  attributes: {
    ...
    class: Attribute.String & Attribute.DefaultTo<'null'>;
    prevSchool: Attribute.String & Attribute.DefaultTo<'null'>;
    highschool: Attribute.String & Attribute.DefaultTo<'null'>;
    major: Attribute.String & Attribute.DefaultTo<'null'>;
    stats: Attribute.Text & Attribute.DefaultTo<'null'>;
    finalist: Attribute.Boolean &
      Attribute.Required &
      Attribute.DefaultTo<false>;
    ...
    years: Attribute.Relation<
      ...
      'api::year.year'
    >;
    jerseyNum: Attribute.Integer & Attribute.DefaultTo<0>;
    weight: Attribute.Integer;
    sport: Attribute.Enumeration<
      ['football', 'basketball (M)', 'baseball', 'basketball (W)']
    > &
      Attribute.Required;
    ...
    > &
      Attribute.Required;
    hometown: Attribute.String & Attribute.DefaultTo<'null'>;
    school: Attribute.Relation<
      'api::athlete.athlete',
      'oneToOne',
      'api::school.school'
    >;
    positionFullName: Attribute.Enumeration<
      [
        'Quarterback ',
        'Wide Receiver',
        'Running Back',
    ...
    ceremonyVideo: Attribute.Media;
    highlightsVideo: Attribute.Media;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
...
export interface ApiAwardAward extends Schema.CollectionType {
  ...
  attributes: {
    ...
    years: Attribute.Relation<
      ...
      'api::year.year'
    >;
    awardSelectImage: Attribute.Media & Attribute.Required;
    icon: Attribute.Media;
    sport: Attribute.Enumeration<
      ['football', 'basketball (M)', 'baseball', 'basketball (W)']
    > &
      Attribute.Required;
    trophyImage: Attribute.Media & Attribute.Required;
    awardHistoryImage: Attribute.Media & Attribute.Required;
    athletes: Attribute.Relation<
      'api::award.award',
      'oneToMany',
      'api::athlete.athlete'
    >;
    selectImageLink: Attribute.String;
    iconLink: Attribute.String;
    trophyImageLink: Attribute.String;
    historyImageLink: Attribute.String;
    firstName: Attribute.String;
    jerseyIcon: Attribute.Media;
    jerseyIconLink: Attribute.String;
    sponsorLogo: Attribute.Media;
    sponsorLogoLink: Attribute.String;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
