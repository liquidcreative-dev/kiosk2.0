  ...
  return (
    <div className="video-modal" style={{  zIndex: 1000 }}>
      {/* <div className="video-modal-content" style={{ height: '100%', position: 'relative' }}>
        ...
        <iframe width="560" height="315" src={videoLink} title="video" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" ></iframe>
